window.addEvent('domready',function(){
	...
	$$('.socializer').addEvent('click',function(e){
		...
		closeme.src="/images/mooSocialize/close.gif";
		...
		img.src = '/images/mooSocialize/blinklist.png';
		...
		img.src = '/images/mooSocialize/bookmark.gif';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/delicious.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/digg.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/furl.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/reddit.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/feedmelinks.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/technorati.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/im_yahoo.gif';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/tipd.gif';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/netvouz.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/rojo.png';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/shadows.png';
		img.injectInside(left);
		...
		img.src  = '/images/mooSocialize/oneview.gif';
		img.injectInside(left);
		...
		img.src = '/images/mooSocialize/dzone.png';
		...
		img.src = '/images/mooSocialize/newsvine.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/magnolia.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/stumbleupon.png';
		img.injectInside(right);
		...
		var img = new Element('img');
		img.alt = 'send to google';
		img.src = '/images/mooSocialize/google.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/squidoo.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/spurl.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/blinkbits.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/bmarks.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/bloglines.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/comments.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/scuttle.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/ask.png';
		img.injectInside(right);
		...
		img.src = '/images/mooSocialize/slashdot.png';
		img.injectInside(right);
	...
	//	}).start(0,1);	
		...
		$$('.soc_left a').addEvent('click',function(e){
			...
			closeX.src = "/images/mooSocialize/close.gif";
